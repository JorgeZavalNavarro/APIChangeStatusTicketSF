...
public class AppPropsVO {
    ...
    public String getUrlTpeJustificacionWs() {
        return urlTpeJustificacionWs;
    }

    public void setUrlTpeJustificacionWs(String urlTpeJustificacionWs) {
        this.urlTpeJustificacionWs = urlTpeJustificacionWs;
    }

    public String getUrlTpeJicketupdateWs() {
        return urlTpeJicketupdateWs;
    }

    public void setUrlTpeJicketupdateWs(String urlTpeJicketupdateWs) {
        this.urlTpeJicketupdateWs = urlTpeJicketupdateWs;
    }
    ...
    public String getUrltpechangestatusWs() {
        return urltpechangestatusWs;
    }

    public void setUrltpechangestatusWs(String urltpechangestatusWs) {
        this.urltpechangestatusWs = urltpechangestatusWs;
    }
    ...
    public String toString() {
        return "AppPropsVO{" + "principalAmbiente=" + principalAmbiente + ", urlServicedeskWs=" + urlServicedeskWs + ", urltpechangestatusWs=" + urltpechangestatusWs + ", bddClassDriver=" + bddClassDriver + ", bddUrlFabricante=" + bddUrlFabricante + ", bddConexionServidor=" + bddConexionServidor + ", bddConexionPuerto=" + bddConexionPuerto + ", bddConexionBasedatos=" + bddConexionBasedatos + ", bddConexionUsuario=" + bddConexionUsuario + ", bddConexionPassword=" + bddConexionPassword + ", queryTimeoutSecs=" + queryTimeoutSecs + ", wssdTimeoutConect=" + wssdTimeoutConect + ", wssdTimeoutRead=" + wssdTimeoutRead + ", pathConfigLogs=" + pathConfigLogs + ", wssdUsuario=" + wssdUsuario + ", wssdPassword=" + wssdPassword + ", urlTpeJustificacionWs=" + urlTpeJustificacionWs + ", urlTpeJicketupdateWs=" + urlTpeJicketupdateWs + ", chartsetconfig=" + chartsetconfig + ", languajeConfig=" + languajeConfig + ", wsTpeChangestatusUsuario=" + wsTpeChangestatusUsuario + ", wsTpeChangestatusPassword=" + wsTpeChangestatusPassword + '}';
    }
